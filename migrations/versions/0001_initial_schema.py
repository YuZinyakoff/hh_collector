...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("partitions_total", sa.Integer(), nullable=False, server_default=sa.text("0")),
        sa.Column("partitions_done", sa.Integer(), nullable=False, server_default=sa.text("0")),
        sa.Column("partitions_failed", sa.Integer(), nullable=False, server_default=sa.text("0")),
    ...
    op.create_table(
        ...
        sa.Column("pages_processed", sa.Integer(), nullable=False, server_default=sa.text("0")),
    ...
    op.create_table(
        ...
        sa.Column(
            "crawl_run_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("crawl_run.id", ondelete="SET NULL"),
            nullable=True,
        ),
        sa.Column(
            "crawl_partition_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("crawl_partition.id", ondelete="SET NULL"),
            nullable=True,
        ),
    ...
    op.create_index(
        "idx_api_request_log_requested_at", "api_request_log", [sa.text("requested_at DESC")]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "api_request_log_id",
            sa.BigInteger(),
            sa.ForeignKey("api_request_log.id", ondelete="CASCADE"),
            nullable=False,
        ),
    ...
    op.create_index(
        "idx_raw_api_payload_received_at", "raw_api_payload", [sa.text("received_at DESC")]
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "parent_area_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("area.id", ondelete="SET NULL"),
            nullable=True,
        ),
    ...
    op.create_index("idx_area_parent_area_id", "area", ["parent_area_id"])
    ...
    op.create_table(
        ...
        sa.Column("dictionary_name", sa.Text(), nullable=False),
        sa.Column("status", sa.Text(), nullable=False),
        sa.Column("etag", sa.Text(), nullable=True),
        sa.Column("source_status_code", sa.Integer(), nullable=True),
        sa.Column("notes", sa.Text(), nullable=True),
        sa.Column(
            "started_at",
            sa.DateTime(timezone=True),
    ...
    op.create_index("idx_dictionary_sync_run_name", "dictionary_sync_run", ["dictionary_name"])
    op.create_index(
    ...
    op.create_index("idx_employer_area_id", "employer", ["area_id"])
    ...
    op.create_index("idx_vacancy_published_at", "vacancy", [sa.text("published_at DESC")])
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("professional_role.id", ondelete="CASCADE"),
            primary_key=True,
            nullable=False,
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "crawl_partition_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("crawl_partition.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "seen_at",
        ...
        sa.Column(
            ...
            sa.BigInteger(),
            sa.ForeignKey("raw_api_payload.id", ondelete="SET NULL"),
            nullable=True,
        ),
        sa.UniqueConstraint(
            "vacancy_id",
    ...
    op.create_index(
        "idx_vacancy_seen_event_partition_id", "vacancy_seen_event", ["crawl_partition_id"]
    )
    op.create_index("idx_vacancy_seen_event_run_id", "vacancy_seen_event", ["crawl_run_id"])
    op.create_index(
        "idx_vacancy_seen_event_seen_at", "vacancy_seen_event", [sa.text("seen_at DESC")]
    )
    ...
    op.create_index(
        "idx_vacancy_snapshot_captured_at", "vacancy_snapshot", [sa.text("captured_at DESC")]
    )
...
def downgrade() -> None:
    ...
    op.drop_index("idx_vacancy_seen_event_partition_id", table_name="vacancy_seen_event")
    op.drop_table("vacancy_seen_event")

    op.drop_index("idx_vacancy_prof_role_role_id", table_name="vacancy_professional_role")
    op.drop_table("vacancy_professional_role")
    ...
    op.drop_index("idx_employer_area_id", table_name="employer")
    op.drop_table("employer")

    op.drop_index("idx_dictionary_sync_run_started_at", table_name="dictionary_sync_run")
    op.drop_index("idx_dictionary_sync_run_name", table_name="dictionary_sync_run")
    op.drop_table("dictionary_sync_run")

    op.drop_table("professional_role")

    op.drop_index("idx_area_parent_area_id", table_name="area")
    op.drop_table("area")
