...
Bounded S3 backup retention apply was proven manually on 2026-06-15 and now has
a guarded weekly timer path. Continue with alert-driven monitoring plus a weekly
checklist; before full unattended month mode, deploy/prove the cleanup timer and
decide the separate production collection calendar.
