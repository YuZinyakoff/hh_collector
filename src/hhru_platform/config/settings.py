...
class Settings(BaseSettings):
    ...
    backup_offsite_backend: str = "webdav"
    ...
    backup_offsite_chunk_size_bytes: int = 4 * 1024 * 1024
    backup_offsite_s3_endpoint_url: str = ""
    ...
    backup_offsite_retention_keep_latest: int = 2
    backup_offsite_retention_keep_weekly: int = 0
    ...
    detail_worker_lease_seconds: int = 7200
