...
def run_collection_once_v2(
    ...
    *,
    ...
    if result.status == RUN_COLLECTION_ONCE_V2_STATUS_SUCCEEDED:
        record_operation_succeeded(
            LOGGER,
            operation="run_collection_once_v2",
            started_at=started_at,
